...
import com.example.jetweatherapp.di.ApiCurrentWeatherAnnotation
...
class ApiWeatherMapper @Inject constructor(
    ...
    @ApiCurrentWeatherAnnotation private val apiCurrentWeatherMapper: ApiMapper<CurrentWeather,ApiCurrentWeather>,
